...
domain:
  id: "urn:uuid:223e4567-e89b-42d3-a456-426614174000"
  iid: null
  type: "service"
...
constitution:
  ...
  governance:
    ...
    amendment_procedure: "resource:service-amendment-procedure-v1"
    interpretation_procedure: "resource:service-interpretation-procedure-v1"
    dispute_resolution_procedure: "resource:service-dispute-procedure-v1"
    suspension_procedure: "resource:service-suspension-procedure-v1"
    dissolution_procedure: "resource:service-dissolution-procedure-v1"
  execution:
    mode: "machine_assisted"
    implementations: [ "resource:service-constitutional-policy-v1" ]
    conformance_tests: [ "resource:service-constitutional-tests-v1" ]
...
agents:
  entries:
    - id: "did:ixo:agent:evidence-review-oracle"
      ...
      permitted_context: { domains: [ "urn:uuid:223e4567-e89b-42d3-a456-426614174000" ], claims: [ "claim-collection:field-services" ], resources: [ "rubric-service-delivery-v1" ], rooms: [ "#matrix" ] }
...
The service constitution governs agent participation and is embodied by `documents[id=domain-charter]`. Constitutional-AI critique can revise a proposal, but only current rights and approvals can authorize action.
## Rights & Capabilities
