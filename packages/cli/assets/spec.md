<!-- Generated from spec/spec.mdx and spec/rules.ts | version: 1.0.0-rc.2 -->
...
|  |  |
| :---- | :---- |
| **Specification version** | `1.0.0-rc.2` |
...
The canonical vocabulary is `https://w3id.org/ixo/vocab/v1/constitution#` (`con:`). It makes four
non-interchangeable commitments:

1. A `con:ConstitutionalSubject` is the entity, institutional arrangement, collective, protocol, or agentic
...
and [UN Charter](https://www.un.org/en/about-us/un-charter).

**Tiered requirement.** Every document declares constitutional status. `dao`, `organisation`, `project`,
...
2. **Resolve constitution** — require the tier-appropriate constitutional declaration; resolve exact instrument bytes, effective/superseded status, norms, procedures, execution artifacts, and constitutional-AI profile. A missing or conflicting constitutional dependency fails closed.
...
4. **Constitutional evaluate** — evaluate the proposed action against applicable constitutive, prescriptive, and procedural norms. Constitutional AI may supply context, critique/revision, or policy evaluation but may not authorize the action.
...
`14df6d10d467712265216bfa6270dc6f59e0863b`. Terms are specialized with RDFS/OWL and organized with SKOS;
