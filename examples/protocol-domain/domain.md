...
constitution:
  ...
  instruments:
    - { document_ref: "domain-charter", type: "con:ProtocolSpecification", functions: [ "constitutive", "governing" ], canonical: true, effective_from: null, effective_until: null }
  governance:
    authority_sources: [ "domain-charter" ]
    decision_procedure: "resource:protocol-decision-procedure-v1"
    amendment_procedure: "resource:protocol-amendment-procedure-v1"
    interpretation_procedure: "resource:protocol-interpretation-procedure-v1"
    dispute_resolution_procedure: "resource:protocol-dispute-procedure-v1"
    suspension_procedure: "resource:protocol-suspension-procedure-v1"
    dissolution_procedure: "resource:protocol-dissolution-procedure-v1"
  execution:
    mode: "hybrid"
    implementations: [ "resource:protocol-governance-runtime-v1" ]
    conformance_tests: [ "resource:protocol-governance-conformance-v1" ]
    enforcement_points: [ "#matrix" ]
    failure_policy: "deny"
    human_review_required_for: [ "protocol_upgrade", "rights_change", "constitutional_amendment" ]
  constitutional_ai:
    mode: "policy_evaluate"
    ...
    decision_procedure: "resource:constitutional-policy-evaluation-v1"
...
agents:
  entries:
    - id: "did:ixo:agent:evidence-review-oracle"
      ...
      permitted_context: { domains: [ "urn:uuid:323e4567-e89b-42d3-a456-426614174000" ], claims: [ "claim-collection:field-services" ], resources: [ "rubric-service-delivery-v1" ], rooms: [ "#matrix" ] }
      permitted_outputs: [ "evaluation_claim", "review_recommendation" ]
      forbidden_outputs: [ "protocol_upgrade", "payment_authorization", "constitutional_amendment" ]
...
The protocol constitution is embodied by `documents[id=domain-charter]` and implemented by a conformance-tested governance runtime. A model policy evaluation is advisory to, and never a substitute for, live protocol authority.
## Rights & Capabilities
